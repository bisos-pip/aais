...
####+BEGIN: bx:icm:python:func :funcName "mainEntry" :funcType "anyOrNone" :retType "bool" :deco "" :argsList ""
"""
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  Func-anyOrNone :: /mainEntry/ retType=bool argsList=nil  [[elisp:(org-cycle)][| ]]
"""
def mainEntry():
####+END:
    print("HERE HERE")
